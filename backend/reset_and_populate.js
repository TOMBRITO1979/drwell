...
async function main() {
    ...
    const user1 = await prisma.user.create({
        data: {
            ...
            password: await bcryptjs_1.default.hash(user1Password, 10),
            name: 'Ana Santos',
    ...
    const user2 = await prisma.user.create({
        data: {
            ...
            password: await bcryptjs_1.default.hash(user2Password, 10),
    ...
    const user3 = await prisma.user.create({
        data: {
            ...
            password: await bcryptjs_1.default.hash(user3Password, 10),
            name: 'Mariana Costa',
            role: client_1.UserRole.USER,
            companyId: company.id,
            active: true,
    ...
    const user4 = await prisma.user.create({
        data: {
            ...
            password: await bcryptjs_1.default.hash(user4Password, 10),
            name: 'Pedro Almeida',
            role: client_1.UserRole.USER,
            companyId: company.id,
            active: true,
    ...
    const casePartsData = [
        ...
        { caseId: createdCases[0].id, type: 'AUTOR', name: 'Maria Aparecida da Silva', cpfCnpj: '123.456.789-00' },
        { caseId: createdCases[0].id, type: 'REU', name: 'Empresa XYZ Ltda', cpfCnpj: '11.222.333/0001-44' },
        // Case 2 - Trabalhista
        { caseId: createdCases[1].id, type: 'AUTOR', name: 'José Carlos Santos', cpfCnpj: '234.567.890-11' },
        { caseId: createdCases[1].id, type: 'REU', name: 'Indústria ABC SA', cpfCnpj: '22.333.444/0001-55' },
        // Case 3 - Divórcio
        { caseId: createdCases[2].id, type: 'AUTOR', name: 'Ana Paula Ferreira', cpfCnpj: '345.678.901-22' },
        { caseId: createdCases[2].id, type: 'REU', name: 'Paulo Roberto Ferreira', cpfCnpj: '111.222.333-44' },
        // Case 4 - Criminal
        { caseId: createdCases[3].id, type: 'REU', name: 'Ricardo Oliveira Lima', cpfCnpj: '456.789.012-33' },
        { caseId: createdCases[3].id, type: 'AUTOR', name: 'Ministério Público', cpfCnpj: '' },
        // Case 5 - Danos Morais
        { caseId: createdCases[4].id, type: 'AUTOR', name: 'Fernanda Costa Almeida', cpfCnpj: '567.890.123-44' },
        { caseId: createdCases[4].id, type: 'REU', name: 'Banco Nacional SA', cpfCnpj: '44.555.666/0001-77' },
        // Case 6 - Dissolução
        { caseId: createdCases[5].id, type: 'AUTOR', name: 'TechSolutions Ltda', cpfCnpj: '12.345.678/0001-99' },
        { caseId: createdCases[5].id, type: 'REU', name: 'Innovation Partners Ltda', cpfCnpj: '55.666.777/0001-88' },
        // Case 7 - Cobrança Aluguel
        { caseId: createdCases[6].id, type: 'AUTOR', name: 'Construtora Boa Vista SA', cpfCnpj: '23.456.789/0001-88' },
        { caseId: createdCases[6].id, type: 'REU', name: 'Locatários Associados Ltda', cpfCnpj: '66.777.888/0001-99' },
        // Case 8 - Consumidor
        { caseId: createdCases[7].id, type: 'AUTOR', name: 'Marcelo Souza Pereira', cpfCnpj: '678.901.234-55' },
        { caseId: createdCases[7].id, type: 'REU', name: 'Eletrônicos Store Ltda', cpfCnpj: '77.888.999/0001-00' },
    ];
...
════════════════════════════════════════════════════════════════
`;
    (0, fs_1.writeFileSync)('/tmp/CREDENTIALS.txt', credentialsOutput);
